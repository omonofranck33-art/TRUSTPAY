...
CREATE DATABASE IF NOT EXISTS trustpay CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE trustpay;  -- toutes les commandes suivantes s'appliquent à cette base
